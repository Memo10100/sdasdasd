...
<section class="heading">
    ...
    <p> <a href="home.php">Home</a> / Comprar </p>
</section>
...
<section class="productos">
   ...
   <div class="box-container">
      ...
      <?php
         $select_productos = mysqli_query($conn, "SELECT * FROM `productos`") or die('query failed');
         ...
         echo '<p class="empty">No has agregado productos!</p>';
      }
      ?>
